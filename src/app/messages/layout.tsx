    ...
    return (
        <div className="h-screen">
            ...
            <div className="h-[calc(100vh_-_56px)] w-full flex">
                <div className="ml-[-300px] md:ml-0 w-full max-w-[300px] lg:max-w-[360px] px-[16px]">
                    <header className="pt-3 pb-4">
                        ...
                        <div className="h-[36px] flex items-center gap-2 rounded-[16px] w-full bg-[#F6F6F7] px-[8px] mb-3">
                        ...
                        >
                            <SwiperSlide className="max-w-max cursor-pointer">
                                <div className="bg-[#F2EEFF] text-primary text-[15px] px-3 py-[6px] rounded-[16px] flex gap-[4px] items-center select-none">
